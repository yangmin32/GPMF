...
from examples.battle_model.senario_pursuit import play3
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, choices={'ac', 'mfac', 'mfq','rnnMFQ', 'rnnIL', 'il', 'pomfq','gamfq'}, help='choose an algorithm from the preset', required=True)
    ...
    if args.algo in ['mfq', 'mfac', 'rnnMFQ', 'pomfq','gamfq']:
        use_mf = True
    else:
        use_mf = False
    ...
    for k in range(start_from, start_from + args.n_round):
        ...
        with open('gamfq1_pursuit_r6.csv', 'a') as myfile:
