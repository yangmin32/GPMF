...
class Gt(nn.Module):
    ...
    def __init__(self,nums,hid_size):
        ...
        self.gat_encoder_normalize = False   
        ...
        self.obs_encoder = nn.Linear(self.obs_size, self.hid_size)   
    ...
    def forward(self,x):  
        ...
        adj = self.sub_scheduler(self.sub_scheduler_mlp, encoded_state, self.agent_mask) 
