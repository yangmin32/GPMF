...
class GridWorld(Environment):
    ...
    def get_neighbors1(self,j,pos_list,r=6):
        """
        Given [x,y] positions of all agents in `pos_list`,
        return indices of agents that are within the radius of agent j (i.e. the j'th index in `pos_list`)
        """
    ...
    def get_observation_whole(self, handle):
        """ 
    ...
    def get_observation(self, handle, handles, listofagentids, grouplist, maxelements):
        """ get observation of a partially observation 
    ...
    def get_observation1(self, handle, handles, listofagentids, grouplist, maxelements):
        """ get observation of a partially observation 
    ...
    def get_observation_gather1(self, food_handle, handle, handles, listofagentids, grouplist, maxelements):
        """ get observation of a whole group
    ...
    def get_neighbors_modify(self,j,adj):
        """
        j 表示第j个智能体
        返回第j个智能体的图节点，为一个列表
        """
