...
from examples.battle_model.senario_gather import play3
from examples.battle_model.senario_gather import play4
...
if __name__ == '__main__':
    ...
    for k in range(start_from, start_from + args.n_round):
        ...
        with open('mfac1_multigather_r6.csv', 'a') as myfile:
